    ...
    const services = [
        {
            ...
            icon: <AuditIcon1 style={{ width: '2.5rem', height: '2.5rem', color: '#8d6e63' }} />
        },
        {
            id: 2,
            title: "Business Advisory & Internal Audit",
            link: "/service/business-advisory-internal-audit/",
            icon: <BusinessIcon2 style={{ width: '2.5rem', height: '2.5rem', color: '#8d6e63' }} />
        },
        {
            id: 3,
            title: "Book Keeping and Outsourcing",
            link: "/service/book-keeping-and-outsourcing/",
            icon: <BookIcon3 style={{ width: '2.5rem', height: '2.5rem', color: '#8d6e63' }} />
        },
        {
            id: 4,
            title: "Goods & Services Tax (GST)",
            link: "/service/good-services-tax/",
            icon: <Tax4 style={{ width: '2.5rem', height: '2.5rem', color: '#8d6e63' }} />
        },
        {
            id: 5,
            title: "Transfer Pricing",
            link: "/service/transfer-pricing/",
            icon: <Transfer5 style={{ width: '2.5rem', height: '2.5rem', color: '#8d6e63' }} />
        },
        {
            id: 6,
            title: "Corporate Financial Advisory",
            link: "/service/corporate-financial-advisory/",
            icon: <Finance6 style={{ width: '2.5rem', height: '2.5rem', color: '#8d6e63' }} />,
        },
        {
            id: 7,
            title: "Risk Advisory",
            link: "/service/risk-advisory/",
            icon: <Warning7 style={{ width: '2.5rem', height: '2.5rem', color: '#8d6e63' }} />
        },
        {
            id: 8,
            title: "Corporate Law & Secretarial Support",
            link: "/service/corporate-law-secretarial-support/",
            icon: <Law8 style={{ width: '2.5rem', height: '2.5rem', color: '#8d6e63' }} />,
